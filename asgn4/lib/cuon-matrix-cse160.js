...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let ax = other1.elements[0], ay = other1.elements[1], az = other1.elements[2];
        let bx = other2.elements[0], by = other2.elements[1], bz = other2.elements[2];
        v3.elements[0] = ay * bz - az * by
        v3.elements[1] = az * bx - ax * bz
        v3.elements[2] = ax * by - ay * bx
        // Don't delete the return statement.
        return v3;
    }
    ...
    magnitude() {
        ...
        let m = Math.sqrt(x * x + y * y + z * z); //sqrt(x^2 + y^2 + z^2)
        // Don't delete the return statement.
        return m;
    };
